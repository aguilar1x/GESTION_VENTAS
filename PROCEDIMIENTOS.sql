...
BEGIN
    ...
    BEGIN
        RAISERROR('YA EXISTE ESA C�DULA JUR�DICA.', 16, 1);
        RETURN;
    END;
...
BEGIN
    ...
    BEGIN
        RAISERROR('LA C�DULA JUR�DICA NO EXISTE EN LA TABLA EMPRESA.', 16, 1);
        RETURN;
    END;
...
BEGIN
    ...
    BEGIN
        RAISERROR('YA EXISTE UNA CATEGOR�A CON ESE NOMBRE.', 16, 1);
        RETURN;
    END;
...
-------- CONSULTAR PRODUCTOS VENDIDOS EN RANGO DE FECHAS --------
CREATE PROCEDURE PRODUCTOS_VENDIDOS_RANGO_FECHAS_SP
...
BEGIN
    SELECT
        ...
        SUM(D.CANTIDAD_VENDIDA) AS 'CANTIDAD VENDIDA',
        P.COSTO_PRODUCTO AS 'COSTO UNITARIO',
        SUM(D.CANTIDAD_VENDIDA * P.COSTO_PRODUCTO) AS 'COSTO TOTAL'
    FROM DETALLE_VENTA D
    INNER JOIN PRODUCTOS P ON D.ID_PRODUCTO = P.ID_PRODUCTO
    INNER JOIN VENTAS V ON D.ID_VENTA = V.ID_VENTA
    WHERE V.FECHA_VENTA BETWEEN @FECHA_INICIO AND @FECHA_FIN
      AND D.ID_ESTADO = 1
    GROUP BY P.CODIGO_PRODUCTO, P.NOMBRE_PRODUCTO, P.COSTO_PRODUCTO
END;
GO

-------- CONSULTAR COSTO INDIVIDUAL DE PRODUCTO --------
CREATE PROCEDURE COSTO_PRODUCTO_SP
    @ID_PRODUCTO INT
AS
BEGIN
    SELECT
...
-------- REPORTE MENSUAL DE VENTAS Y COSTOS --------
CREATE PROCEDURE REPORTE_MENSUAL_VENTAS_COSTOS_SP
    @MES INT,
    @ANIO INT
AS
BEGIN
